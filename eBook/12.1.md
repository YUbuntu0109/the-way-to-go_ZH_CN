...
let's input some string like this.. please push the [Enter] key if wanna to exit it.
The input was : et's input some string like this.. please push the [Enter] key if wanna to exit it.
